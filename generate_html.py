...
episodes = [
    ...
    (10, "千引の岩 ─ 永遠の別離", 1, "天地開闢篇", "千引の岩が閉まり、夫婦は永遠に別れる。「千人殺す」「千五百人生む」──死と生が定まった。"),
    ...
    (34, "高千穂の降臨", 4, "天孫降臨篇", "天孫降臨の最初の行為は──くしゃみ。土の温もりを初めて知った若き神の、地上第一夜。"),
    ...
    (41, "日向を発つ", 5, "神武東征篇", "四兄弟の末弟、空を見上げる癖を持つ男が東を目指す。兄の手が肩に、まだ温かかった頃の話。"),
    (42, "十六年の航海", 5, "神武東征篇", "筑紫で聞き、安芸で斬り、吉備で待つ──十六年が一人の若者を王の器に変えた。"),
    ...
    (48, "ヒメタタライスズ ─ 皇后の秘密", 5, "神武東征篇", "丹塗矢が川を流れ、神の執念が一人の姫を生んだ。天と地の血がようやく交わる。"),
